...
{
    //This script is placed on enemies so that they fade after death
    //PROBLEM: when rendertype is FADE, mesh inverts itself.
    //script from internet, don't remember where.
    [Range(0.1f, 1.0f)]
